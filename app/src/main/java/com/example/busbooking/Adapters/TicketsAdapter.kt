...
class TicketsAdapter(private val tickets:List<BookingsModel>, private val viewModel: HistoryViewModel):RecyclerView.Adapter<TicketsAdapter.ViewHolder>() {
